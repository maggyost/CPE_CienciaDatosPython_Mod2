...
a_m = np.apply_along_axis(np.mean,axis=0,arr=a_matriz)
print(a_m)

# Proesa el promedio de la matriz por fila
a_m = np.apply_along_axis(np.mean,axis=1,arr=a_matriz)
print(a_m)
...
# Procesa el promedio de la matriz por columna
a_m = np.apply_along_axis(potencia, axis=0, arr=a_matriz)
print(a_m)

# Procesa el promedio de la matriz por fila
a_m = np.apply_along_axis(potencia, axis=1, arr=a_matriz)
print(a_m)